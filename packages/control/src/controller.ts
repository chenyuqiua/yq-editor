...
export class Controller extends DisplayObject {
  ...
  constructor() {
    ...
    // 在将wrapper添加el上, 最终控制层暴露的操作元素就是el
  ...
  render(): void {
    ...
    this.el.style.height = `${
      this.size.height * this.scale.y * pInfo.scale.y
    }px`;
